...
import { setLaundryOngoingDetail, setShowOngoingDetail } from '../../slice/ServiceSlice';

type Props ={
    item: LaundryItemType
}

const SingleOngoingItem = ({ item }: Props) => {
    ...
    const handleShowItemItems = () => {
        dispatch(setLaundryOngoingDetail({
            amount: item.amount,
        ...
        dispatch(setShowOngoingDetail(true))
...
export default SingleOngoingItem
