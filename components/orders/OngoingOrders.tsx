...
import { selectLaundryOngoingDetail, selectShowOngoingDetail, setShowOngoingDetail } from '../../slice/ServiceSlice'
import LoadingIndicator from '../loadingIndicator'
import SingleOngoingItem from './SingleOngoingItem'
...
const OngoingOrders = () => {
    ...
    const showDetails = useSelector(selectShowOngoingDetail)
    const getOngoingOrderDetails = useSelector(selectLaundryOngoingDetail)
    ...
    const handleCLoseDetail = () => {
        dispatch(setShowOngoingDetail(false))
    }
